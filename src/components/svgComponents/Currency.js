...
class Currency extends React.Component {
    ...
    render() {
        const { caretActivated } = this.state;

        return(
            <div className="container" onClick={this.handleClick}>
                <svg className="currency" width="11" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className={caretActivated ? 'caret-activated' : 'caret'} width="8" height="4" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
